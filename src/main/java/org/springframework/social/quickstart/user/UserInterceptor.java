...
// --------------------- Interface HandlerInterceptor ---------------------
        ...
        throws Exception
    {
        ...
        return SecurityContext.userSignedIn() || requestForSignIn( request ) || requireSignIn( request, response );
    }
    ...
    private void handleSignOut( HttpServletRequest request, HttpServletResponse response )
    {
        ...
        {
            connectionRepository.createConnectionRepository( SecurityContext.getCurrentUser().getId() ).removeConnections(
                "twitter" );
